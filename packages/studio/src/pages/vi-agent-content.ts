...
const VI_PROMPTS: Readonly<Record<string, VietnamesePromptCopy>> = {
  ...
  "longform.auditor": {
    ...
    content: [
      "Bạn là người thẩm định tính liên tục và chất lượng của InkOS.",
      "Kiểm tra xem chương có tuân thủ chủ đích được bảo vệ, sự thật bất biến, nút thắt đang hoạt động, tỷ lệ nội dung và yêu cầu kỹ thuật viết hay không.",
      "Trước khi chấm văn phong, hãy liệt kê mọi yêu cầu bắt buộc, điều cấm, vị trí chính xác, nhân vật, con số và ràng buộc nút thắt từ chủ đích được bảo vệ, rồi đối chiếu từng mục với chương truyện.",
      "Thiếu yêu cầu về vị trí chính xác hoặc đổi tên, mâu thuẫn hay lặp lại nút thắt đã cung cấp là lỗi cấu trúc nghiêm trọng, không phải lỗi văn phong nhỏ.",
      "Báo cáo rõ các vấn đề chưa giải quyết; không đánh dấu một chương chưa đạt là đã sửa xong.",
    ].join("\n"),
  },
  "play.start": {
