  ...
  private localize(language: LengthLanguage, messages: { zh: string; en: string }): string {
    if (language === "vi") {
      const exact: Readonly<Record<string, string>> = {
        ...
        "importing fanfic canon": "Đang nhập dữ kiện gốc cho truyện đồng nhân",
        "generating fanfic foundation": "Đang tạo nền tảng truyện đồng nhân",
        "extracting source style fingerprint": "Đang trích xuất đặc trưng phong cách bản gốc",
        "importing parent canon": "Đang nhập dữ kiện từ truyện chính",
        "generating side-story foundation": "Đang tạo nền tảng ngoại truyện",
        "extracting reference style fingerprint": "Đang trích xuất đặc trưng phong cách tác phẩm tham chiếu",
        "preparing chapter inputs": "Đang chuẩn bị dữ liệu chương",
        "writing chapter draft": "Đang viết bản nháp chương",
        "persisting draft and truth files": "Đang lưu bản nháp và các tệp sự thật",
        "updating chapter index and snapshots": "Đang cập nhật chỉ mục chương và ảnh chụp trạng thái",
        "planning next chapter intent": "Đang lập ý định cho chương tiếp theo",
        "composing chapter runtime context": "Đang tổng hợp ngữ cảnh vận hành của chương",
        "draft written — stopping for manual review": "Đã viết xong bản nháp — đang dừng để duyệt thủ công",
        ...
        "repairing chapter state settlement": "Đang sửa phần quyết toán trạng thái chương",
        "syncing truth files and indexes from edited chapter body": "Đang đồng bộ tệp sự thật và chỉ mục từ nội dung chương đã chỉnh sửa",
