...
const SLASH_COMMAND_VARIANTS: ReadonlyArray<{ zh: string; en: string; vi: string }> = [
  { zh: "/new 输入你的想法", en: "/new describe your idea", vi: "/new mô tả ý tưởng" },
  { zh: "/short 输入短篇方向", en: "/short describe the short", vi: "/short mô tả truyện ngắn" },
  { zh: "/play [open|guided] 输入互动世界开局", en: "/play [open|guided] describe the opening", vi: "/play [open|guided] mô tả phần mở đầu" },
  { zh: "/cover 输入封面方向", en: "/cover describe the cover", vi: "/cover mô tả bìa" },
